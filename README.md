...
- Página dedicada à Patrulha de Ações de Comandos (PAC);
- Página dedicada à Intervenção Tática;
- Formulário de denúncia anônima;
- Links internos para navegação entre seções;
- Integração com perfil oficial do Instagram;
